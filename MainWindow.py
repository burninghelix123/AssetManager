...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def contextActions(self, actions, listVar, MainWindowFunctions):
        ...
        actions[7].triggered.connect(lambda : OpenAsset.openFileWithMaya(self, listVar))
        actions[8].triggered.connect(lambda : OpenAsset.openFileWithHoudini(self, listVar))
        actions[9].triggered.connect(lambda : OpenAsset.openFileWithNuke(self, listVar))
        actions[10].triggered.connect(lambda : OpenAsset.openFileWithPhotoshop(self, listVar))
